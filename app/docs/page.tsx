        ...
        <section id="architecture" className={styles.section}>
          ...
          <div className={styles.pipeline}>
            {[
              ...
              { id: "04.2", name: "Experience Contract", file: "project-spec-builder.ts", desc: "Compiles the chosen direction into ProjectSpec v2: complexity profile, routes, nested regions, interactions, visual depth, media policy, file budgets, and a task-bearing first viewport whose visual scale remains unrestricted." },
