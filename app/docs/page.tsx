        ...
        <section id="architecture" className={styles.section}>
          ...
          <div className={styles.pipeline}>
            {[
              ...
              { id: "04.1", name: "Direction Selection", file: "direction-board.ts + direction-portfolio.ts", desc: "Selects six brief-sensitive cells from an 18-cell pool while preserving two combinational, two exploratory, two transformational, and six distinct experience models. Selection applies a quality floor, then archive distance, then brief fit; estimated likelihood is not a reward." },
              { id: "04.15", name: "Typography Contract", file: "typography-contract.ts", desc: "Chooses a direction- and script-sensitive profile, then declares exact local OFL files, Unicode coverage, display/body/mono roles, fallback policy, and executable CSS. Arabic and mixed briefs receive both Arabic and Latin subsets; runtime font CDNs are forbidden." },
              { id: "04.2", name: "Visual Narrative Contract", file: "visual-narrative-builder.ts + project-spec-builder.ts", desc: "Compiles the chosen direction into semantic routes and connected story scenes with audience questions, focal objects, evidence, actions, visible consequences, art direction, a functional richness budget, and a task-bearing first viewport whose scale remains unrestricted." },
              { id: "04.3", name: "Scene Asset Director", file: "asset-director.ts + visual-intent.ts", desc: "Assigns approved licensed assets or explicit programmatic/fallback media to each story scene, including purpose, expected layers, responsive framing, alt intent, and source trace." },
              ...
              { id: "06", name: "Proof Gates",           file: "scorer + diversity + render-gate + engineering", desc: "Scores the delivered code, detects Verve's own repeated house template, measures FVE, FVF, Rendered Evidence Salience, and Direction Fidelity, and keeps visual distinctiveness separate from engineering and production readiness." },
              ...
              { id: "07", name: "Project Assembly",       file: "project-builder.ts", desc: "Creates the complete Next.js, React/Vite, or HTML project: source, local image and font binaries, executable typography CSS, runtime entry, package manifest, project README, ASSETS receipt, and complete font-license text." },
            ].map((step, i, arr) => (
        ...
        <section id="engine" className={styles.section}>
          ...
          {[
            ...
            },
            {
              ...
              desc: "Explores six brief-sensitive directions selected from an 18-cell pool and distributed across combinational, exploratory, and transformational classes. Verve applies a brief-quality floor, then maximizes distance from recent local fingerprints, with no likelihood reward or brand-style imitation.",
            },
            {
