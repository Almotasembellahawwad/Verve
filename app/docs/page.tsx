        ...
        <section id="architecture" className={styles.section}>
          ...
          <div className={styles.pipeline}>
            {[
              ...
              { id: "06", name: "Proof Gates",           file: "scorer + diversity + render-gate + engineering", desc: "Scores the delivered code, detects Verve's own repeated house template, measures first-viewport task effectiveness, and keeps visual distinctiveness separate from engineering and production readiness." },
