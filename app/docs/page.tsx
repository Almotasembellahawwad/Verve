        ...
        <section id="architecture" className={styles.section}>
          ...
          <div className={styles.pipeline}>
            {[
              ...
              { id: "04.2", name: "Visual Narrative Contract", file: "visual-narrative-builder.ts + composition-genome.ts + project-spec-builder.ts", desc: "Compiles semantic routes and story scenes, then assigns each scene a fitness-constrained maximin spatial genome across structure, focus, flow, overlap, depth, density, framing, continuity, and mobile transformation." },
              ...
              { id: "05.5", name: "Syntax + Repair",     file: "code-quality-loop.ts", desc: "Parses TSX with TypeScript, verifies structure and the signature element, and performs one bounded repair pass." },
                { id: "06", name: "Proof Gates",           file: "scorer + diversity + render-gate + engineering", desc: "Scores the delivered code, detects Verve's own repeated house template, measures FVE, FVF, Rendered Evidence Salience, Rendered Composition Realization, and Direction Fidelity, and keeps visual distinctiveness separate from engineering and production readiness." },
