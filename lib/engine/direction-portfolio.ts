...
const DEFAULT_IDENTITIES = [
  { palette: [{ name: "Apricot", hex: "#F5A46C", role: "conversation field" }, { name: "Deep Teal", hex: "#073B3A", role: "decision text" }, { name: "Milk", hex: "#FFF8E9", role: "reading surface" }, { name: "Blue Note", hex: "#3366FF", role: "active state" }], displayTypeface: '"Bricolage Grotesque Variable", sans-serif', bodyTypeface: '"Manrope Variable", sans-serif' },
  { palette: [{ name: "Limestone", hex: "#E8E0D1", role: "map surface" }, { name: "Plan Ink", hex: "#242A23", role: "annotation" }, { name: "Cobalt", hex: "#2454D7", role: "survey mark" }, { name: "Moss", hex: "#667A58", role: "material layer" }], displayTypeface: '"Newsreader Variable", serif', bodyTypeface: '"Manrope Variable", sans-serif' },
  { palette: [{ name: "Instrument", hex: "#091013", role: "work surface" }, { name: "Phosphor", hex: "#B7F34B", role: "live status" }, { name: "Ice", hex: "#D7F8FF", role: "primary data" }, { name: "Steel", hex: "#56656C", role: "inactive state" }], displayTypeface: '"IBM Plex Mono", monospace', bodyTypeface: '"Manrope Variable", sans-serif' },
  { palette: [{ name: "Sun", hex: "#FFCB3D", role: "collection family" }, { name: "Iris", hex: "#7357FF", role: "selection" }, { name: "Leaf", hex: "#3BBD78", role: "filter family" }, { name: "Ink", hex: "#17131D", role: "type and outline" }], displayTypeface: '"Fraunces Variable", serif', bodyTypeface: '"Manrope Variable", sans-serif' },
  { palette: [{ name: "Night", hex: "#151021", role: "environment" }, { name: "Pulse", hex: "#FF4FA1", role: "responsive object" }, { name: "Mist", hex: "#E9E2FF", role: "instruction" }, { name: "Volt", hex: "#C7FF45", role: "active handle" }], displayTypeface: '"Manrope Variable", sans-serif', bodyTypeface: '"Manrope Variable", sans-serif' },
  { palette: [{ name: "Paper", hex: "#F4EBDD", role: "chapter field" }, { name: "Wine", hex: "#6E1839", role: "voice" }, { name: "Sky", hex: "#73B9DB", role: "turning point" }, { name: "Coal", hex: "#25211F", role: "caption" }], displayTypeface: '"Instrument Serif", serif', bodyTypeface: '"Manrope Variable", sans-serif' },
];
