...
const architectureProject: GeneratedProject = {
  ...
  files: [
    ...
    { path: "styles.css", content: architectureCss, language: "css", role: "source" },
...
const carbonProject: GeneratedProject = {
  ...
  files: [
    ...
    { path: "styles.css", content: carbonCss, language: "css", role: "source" },
...
export const PUBLIC_DEMOS = [
  { id: "architecture", index: "01", category: "Adaptive reuse / London", title: "Reframe", description: "A material architecture practice built around a retention register.", brief: architectureBrief, result: architectureResult },
  { id: "cairo", index: "02", category: "Hospitality / Arabic RTL", title: "Maeda Cairo", description: "A seasonal Egyptian restaurant with an Arabic-first editorial system.", brief: PUBLIC_DEMO_BRIEF, result: PUBLIC_DEMO_RESULT },
  { id: "carbon", index: "03", category: "Climate SaaS / Operations", title: "Ledgerline", description: "A manufacturing carbon product organized as an exception ledger.", brief: carbonBrief, result: carbonResult },
] as const;
