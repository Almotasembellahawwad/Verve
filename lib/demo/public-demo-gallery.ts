...
const architectureCssV2 = `${architectureCss}\n@media(min-width:761px){.hero h1{max-width:76%;font-size:clamp(4.8rem,10vw,8.5rem);line-height:.76}.hero-note{right:4vw;width:min(280px,23vw);background:var(--concrete)}.eyebrow{margin-bottom:6vh}}`;
...
const architectureProject: GeneratedProject = {
  ...
  dependencies: {}, scripts: {}, warnings: ["BLOCKING: Media Gate requires approved project photography before this architecture structure proof can represent a real practice."],
...
const carbonCssV2 = `${carbonCss}\n@media(min-width:761px){.hero{min-height:0;display:grid;grid-template-columns:minmax(260px,.72fr) minmax(340px,1fr) 220px;grid-template-rows:auto 1fr auto;gap:34px 6vw;padding-block:54px}.eyebrow{grid-column:1/-1;margin:0}.hero h1{grid-column:1/3;align-self:end;font-size:clamp(3.8rem,6.5vw,7rem);line-height:.82}.hero h1 em{font-family:inherit;font-style:normal;font-weight:900;color:var(--signal)}.reading{position:static;grid-column:3;grid-row:2/4;align-self:stretch;width:auto;aspect-ratio:auto;min-height:260px}.intro{grid-column:1/3;width:min(580px,100%);margin:0;font-family:Arial,"Segoe UI",sans-serif;font-size:1rem}.ledger{padding-block:80px}.ledger>header{align-items:start}.method{min-height:620px}.cta{min-height:620px}}`;
...
export const PUBLIC_DEMOS = [
  { id: "architecture", index: "01", category: "Adaptive reuse / London", title: "Reframe", description: "A plan-canvas architecture structure awaiting owned project photography.", proof: "STRUCTURE PROOF · MEDIA REQUIRED", brief: architectureBrief, result: architectureResult },
  { id: "cairo", index: "02", category: "Hospitality / Arabic RTL", title: "Maeda Cairo", description: "A menu-first Arabic service system awaiting venue and dish photography.", proof: "STRUCTURE PROOF · MEDIA REQUIRED", brief: PUBLIC_DEMO_BRIEF, result: PUBLIC_DEMO_RESULT },
  { id: "carbon", index: "03", category: "Climate SaaS / Operations", title: "Ledgerline", description: "A dense manufacturing exception interface that deliberately avoids stock media.", proof: "INTERFACE PROOF · MEDIA OPTIONAL", brief: carbonBrief, result: carbonResult },
] as const;

export type PublicDemoId = (typeof PUBLIC_DEMOS)[number]["id"];
