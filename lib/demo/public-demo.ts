...
const demoCssV2 = `${demoCss}\n@media(min-width:761px){.hero{min-height:620px;display:grid;grid-template-columns:minmax(320px,.82fr) minmax(440px,1.18fr);grid-template-rows:auto 1fr auto;gap:24px 7vw}.kicker{grid-column:2;margin:0}.hero h1{grid-column:2;align-self:center;font-size:clamp(4.2rem,7vw,7.4rem);line-height:.8}.hero-foot{grid-column:2;width:100%;margin:0}.sun{inset-inline-start:6vw;inset-block-start:18%;width:min(30vw,390px)}.season{inset-inline-end:auto;inset-inline-start:7vw;inset-block-start:auto;inset-block-end:8%}.menu{display:grid;grid-template-columns:minmax(220px,.55fr) minmax(0,1.45fr);gap:7vw}.section-head{grid-template-columns:1fr;align-content:start;margin:0}.dishes{align-self:start}}`;
