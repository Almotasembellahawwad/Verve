...
function assetManifest(plan: DesignPlan, assetDirection?: AssetDirectionContract): string {
...
- Remote Pexels catalog URLs are preview dependencies, not bundled production assets. Copy selected files into the project and preserve their source records before launch.
...
@media (prefers-reduced-motion: reduce) {
  *, *::before, *::after { scroll-behavior: auto !important; animation-duration: 0.01ms !important; animation-iteration-count: 1 !important; transition-duration: 0.01ms !important; }
  ...
  files.push(
    ...
    file("ASSETS.md", assetManifest(plan, assetDirection), "markdown", "documentation"),
  );
...
export function buildGeneratedProject(
  ...
  const project = generated.framework === "html"
    ? htmlProject(name, generated, analysis, plan, assetDirection)
    : generated.framework === "react"
      ? reactProject(name, generated, analysis, plan, assetDirection)
      : nextProject(name, generated, analysis, plan, assetDirection);
