...
// --- BEFORE: Generic AI output -- every cliche documented ---
// Inter font, cream background, soft-shadow card, indigo CTA, vague copy.
const BEFORE_HTML = `
<style>
  @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');
  .b-wrap { font-family: 'Inter', sans-serif; padding: 28px 24px; max-width: 340px; width: 100%; }
  .b-badge { display: inline-block; background: #EEF2FF; color: #6366F1; font-size: 11px; font-weight: 600; padding: 4px 10px; border-radius: 999px; margin-bottom: 16px; letter-spacing: 0.04em; }
  .b-h2 { color: #111827; font-size: 22px; font-weight: 700; line-height: 1.3; margin-bottom: 10px; }
  .b-p { color: #6B7280; font-size: 13px; line-height: 1.65; margin-bottom: 20px; }
  .b-cards { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 20px; }
  .b-card { background: #fff; border-radius: 10px; padding: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); }
  .b-card-icon { font-size: 18px; margin-bottom: 6px; }
  .b-card-label { font-size: 11px; font-weight: 600; color: #374151; }
  .b-card-val { font-size: 13px; font-weight: 700; color: #111827; }
  .b-btn { display: block; width: 100%; background: linear-gradient(135deg, #6366F1, #8B5CF6); color: #fff; padding: 11px 20px; border-radius: 8px; border: none; font-weight: 600; font-size: 13px; cursor: pointer; text-align: center; font-family: 'Inter', sans-serif; }
  .b-social { display: flex; gap: 6px; margin-top: 14px; font-size: 11px; color: #9CA3AF; align-items: center; justify-content: center; }
</style>
<div class="b-wrap">
  ...
  <div class="b-cards">
    <div class="b-card">
      ...
      <div class="b-card-val">3x faster</div>
    </div>
    <div class="b-card">
      <div class="b-card-icon">&#128737;</div>
  ...
  <button class="b-btn">Get Started Free &rarr;</button>
  <div class="b-social">
...
// --- AFTER: Verve output -- every cliche explicitly countered ---
...
<style>
  ...
  .a-wrap { font-family: 'IBM Plex Mono', monospace; padding: 24px 26px; max-width: 340px; width: 100%; }
  .a-score { font-size: 10px; color: #D49020; letter-spacing: 0.12em; text-transform: uppercase; margin-bottom: 16px; opacity: 0.9; font-weight: 600; }
  .a-h2 { color: #F0ECD6; font-size: 20px; font-weight: 700; font-family: 'Space Grotesk', sans-serif; letter-spacing: -0.04em; line-height: 1.1; margin-bottom: 12px; }
  .a-annotation { color: #9E9A88; font-size: 11.5px; line-height: 1.7; margin-bottom: 18px; border-left: 2px solid rgba(212,144,32,0.45); padding-left: 12px; }
  .a-metrics { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1px; background: rgba(255,255,255,0.05); margin-bottom: 20px; border: 1px solid rgba(212,144,32,0.1); }
  .a-metric { background: #141210; padding: 10px 10px 8px; }
  .a-metric-key { font-size: 9px; color: #5A5648; letter-spacing: 0.1em; text-transform: uppercase; display: block; margin-bottom: 4px; }
  .a-metric-val { font-size: 15px; font-weight: 600; color: #D49020; font-family: 'Space Grotesk', sans-serif; display: block; }
  .a-btn { display: inline-block; background: #D49020; color: #0F0D0B; padding: 10px 20px; border: none; font-weight: 700; font-size: 11px; cursor: pointer; letter-spacing: 0.06em; font-family: 'Space Grotesk', sans-serif; text-transform: uppercase; clip-path: polygon(0 0, calc(100% - 8px) 0, 100% 8px, 100% 100%, 8px 100%, 0 calc(100% - 8px)); }
  .a-sig { margin-top: 14px; font-size: 9.5px; color: #5A5648; letter-spacing: 0.08em; text-transform: uppercase; }
  .a-sig span { color: #39FF14; margin-right: 6px; }
</style>
<div class="a-wrap">
  <div class="a-score">// distinctiveness: 91 &mdash; grade A</div>
  ...
  <div class="a-sig"><span>&#9608;</span> signal active &mdash; verve v1.0</div>
</div>`;
...
export function BeforeAfterHero({ standalone = false }: { standalone?: boolean }) {
  ...
  return (
    <div className={`${styles.comparisonRoot} ${standalone ? styles.standalone : ""}`}>
      ...
      {/* Fixed labels -- each anchored to its own side */}
